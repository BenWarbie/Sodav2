...
from cpython.exc cimport (PyErr_Clear, PyErr_GivenExceptionMatches,
                          PyErr_Occurred)
from cpython.list cimport PyList_Append, PyList_GET_ITEM, PyList_GET_SIZE
from cpython.object cimport Py_NE, PyObject_RichCompareBool
from cpython.ref cimport Py_INCREF, Py_XDECREF, PyObject
from cpython.sequence cimport PySequence_Check
from cpython.set cimport PySet_Add, PySet_Contains
from cpython.tuple cimport (PyTuple_GET_ITEM, PyTuple_GetSlice, PyTuple_New,
                            PyTuple_SET_ITEM)
