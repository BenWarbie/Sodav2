...
from toolz.functoolz import (InstanceProperty, has_keywords, has_varargs,
                             instanceproperty, is_arity, is_partial_args,
                             is_valid_args, num_required_args)

cimport cython
from cpython.dict cimport PyDict_Merge, PyDict_New
from cpython.object cimport (Py_EQ, Py_NE, PyCallable_Check, PyObject_Call,
