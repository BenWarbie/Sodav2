from cpython.dict cimport (PyDict_Check, PyDict_CheckExact, PyDict_DelItem,
                           PyDict_GetItem, PyDict_New, PyDict_Next,
                           PyDict_SetItem, PyDict_Update)
from cpython.list cimport PyList_Append, PyList_New
from cpython.object cimport PyObject_SetItem
from cpython.ref cimport Py_DECREF, Py_INCREF, Py_XDECREF, PyObject
# Locally defined bindings that differ from `cython.cpython` bindings
from cytoolz.cpython cimport PtrIter_Next, PyDict_Next_Compat
