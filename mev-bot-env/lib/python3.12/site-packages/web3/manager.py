...
from typing import (TYPE_CHECKING, Any, AsyncGenerator, Callable, Coroutine,
                    List, Optional, Sequence, Tuple, Union, cast)

from eth_utils.toolz import pipe
from hexbytes import HexBytes
from web3._utils.batching import RequestBatcher
...
from web3.exceptions import (BadResponseFormat, MethodUnavailable,
                             ProviderConnectionError, RequestTimedOut,
                             TaskNotRunning, TransactionNotFound, Web3RPCError,
                             Web3TypeError)
from web3.method import Method
from web3.middleware import (AttributeDictMiddleware,
                             BufferedGasEstimateMiddleware,
                             ENSNameToAddressMiddleware,
                             GasPriceStrategyMiddleware, ValidationMiddleware)
from web3.middleware.base import Middleware, MiddlewareOnion
from web3.module import apply_result_formatters
from web3.providers import (AutoProvider, JSONBaseProvider,
...
if TYPE_CHECKING:
    ...
    from web3.middleware.base import Web3Middleware  # noqa: F401
