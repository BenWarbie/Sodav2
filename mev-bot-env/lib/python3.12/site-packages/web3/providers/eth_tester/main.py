...
from ...exceptions import Web3TypeError
from ...middleware import async_combine_middleware, combine_middleware
from .middleware import (default_transaction_fields_middleware,
...
if TYPE_CHECKING:
    ...
    from web3.middleware.base import (Middleware,  # noqa: F401
                                      MiddlewareOnion, Web3Middleware)
