...
from web3.beacon.api_endpoints import (GET_ATTESTATIONS,
                                       GET_ATTESTER_SLASHINGS,
                                       GET_BEACON_HEADS, GET_BEACON_STATE,
                                       GET_BLINDED_BLOCKS, GET_BLOB_SIDECARS,
                                       GET_BLOCK, GET_BLOCK_ATTESTATIONS,
                                       GET_BLOCK_HEADER, GET_BLOCK_HEADERS,
                                       GET_BLOCK_ROOT,
                                       GET_BLS_TO_EXECUTION_CHANGES,
                                       GET_DEPOSIT_CONTRACT,
                                       GET_EPOCH_COMMITTEES, GET_EPOCH_RANDAO,
                                       GET_EPOCH_SYNC_COMMITTEES,
                                       GET_FINALITY_CHECKPOINT, GET_FORK_DATA,
                                       GET_FORK_SCHEDULE, GET_GENESIS,
                                       GET_HASH_ROOT, GET_HEALTH,
                                       ...
                                       GET_NODE_IDENTITY, GET_PEER, GET_PEERS,
                                       GET_PROPOSER_SLASHINGS, GET_REWARDS,
                                       GET_SPEC, GET_SYNCING, GET_VALIDATOR,
                                       GET_VALIDATOR_BALANCES, GET_VALIDATORS,
                                       GET_VERSION, GET_VOLUNTARY_EXITS)
