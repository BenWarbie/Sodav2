...
from eth_utils import (add_0x_prefix, encode_hex, is_bytes, is_hex,
                       is_list_like, remove_0x_prefix, to_bytes, to_hex)
from eth_utils.toolz import curry
from hexbytes import HexBytes
from web3._utils.abi import (is_address_type, is_array_type, is_bool_type,
                             is_bytes_type, is_int_type, is_string_type,
                             is_uint_type, size_of_type,
                             sub_type_of_array_type)
from web3._utils.validation import validate_abi_type, validate_abi_value
from web3.datastructures import AttributeDict
from web3.exceptions import Web3TypeError, Web3ValueError
...
def encode_single_packed(_type: TypeStr, value: Any) -> bytes:
    ...
    from eth_abi import grammar as abi_type_parser
