...
from typing import TYPE_CHECKING, Any, Callable, List, Type, Union, cast

import eth_abi as abi
import pytest
from eth_typing import BlockNumber, ChecksumAddress, HexAddress, HexStr
from eth_utils import (is_boolean, is_bytes, is_checksum_address, is_dict,
                       is_integer, is_list_like, is_same_address, is_string,
                       remove_0x_prefix, to_bytes)
from eth_utils.toolz import assoc
from hexbytes import HexBytes
from web3._utils.ens import ens_addresses
from web3._utils.error_formatters_utils import PANIC_ERROR_CODES
from web3._utils.fee_utils import PRIORITY_FEE_MIN
from web3._utils.method_formatters import to_hex_if_integer
from web3._utils.module_testing.module_testing_utils import (
    assert_contains_log, async_mock_offchain_lookup_request_response,
    flaky_geth_dev_mining, flaky_with_xfail_on_exception,
    mock_offchain_lookup_request_response)
from web3._utils.module_testing.utils import RequestMocker
from web3._utils.type_conversion import to_hex_if_bytes
from web3.exceptions import (BlockNotFound, ContractCustomError,
                             ContractLogicError, ContractPanicError,
                             InvalidAddress, InvalidTransaction,
                             MultipleFailedRequests, NameNotFound,
                             OffchainLookup, RequestTimedOut, TimeExhausted,
                             TooManyRequests, TransactionNotFound,
                             TransactionTypeMismatch, Web3RPCError,
                             Web3ValidationError, Web3ValueError)
from web3.middleware import (ExtraDataToPOAMiddleware,
                             SignAndSendRawMiddlewareBuilder)
from web3.types import (ENS, BlockData, FilterParams, Nonce, RPCEndpoint,
                        StateOverrideParams, SyncStatus, TxData, TxParams, Wei)
...
if TYPE_CHECKING:
    ...
    from web3.contract import AsyncContract, Contract  # noqa: F401
    from web3.main import AsyncWeb3, Web3  # noqa: F401
