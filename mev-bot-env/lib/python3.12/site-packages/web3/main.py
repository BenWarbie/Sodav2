...
from typing import (TYPE_CHECKING, Any, AsyncIterator, Callable, Dict,
                    Generator, List, Optional, Sequence, Type, Union, cast)
...
from eth_utils import (add_0x_prefix, apply_to_return_value, combomethod,
                       from_wei, is_address, is_checksum_address)
from eth_utils import keccak as eth_utils_keccak
from eth_utils import (remove_0x_prefix, to_bytes, to_checksum_address, to_int,
                       to_text, to_wei)
from hexbytes import HexBytes
from web3._utils.abi import (build_non_strict_registry, build_strict_registry,
                             map_abi_data)
...
from web3.exceptions import Web3TypeError, Web3ValidationError, Web3ValueError
from web3.geth import (AsyncGeth, AsyncGethAdmin, AsyncGethDebug,
                       AsyncGethTxPool, Geth, GethAdmin, GethDebug, GethTxPool)
...
from web3.providers.persistent import PersistentConnection
...
if TYPE_CHECKING:
    ...
    from web3.providers.persistent import \
        PersistentConnectionProvider  # noqa: F401
