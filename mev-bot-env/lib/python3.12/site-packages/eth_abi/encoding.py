...
from eth_abi.base import BaseCoder, parse_tuple_type_str, parse_type_str
from eth_abi.exceptions import (EncodingTypeError, IllegalValue,
                                ValueOutOfBounds)
from eth_abi.utils.numeric import (TEN, abi_decimal_context, ceil32,
                                   compute_signed_fixed_bounds,
                                   compute_signed_integer_bounds,
                                   compute_unsigned_fixed_bounds,
                                   compute_unsigned_integer_bounds)
from eth_abi.utils.padding import fpad, zpad, zpad_right
from eth_abi.utils.string import abbr
from eth_utils import (int_to_big_endian, is_address, is_boolean, is_bytes,
                       is_integer, is_list_like, is_number, is_text,
