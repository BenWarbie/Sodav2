...
from numpy._typing import (  # Arrays; DTypes; Shapes; Scalars; `number` precision; NOTE: Do not remove the extended precision bit-types even if seemingly unused;; they're used by the mypy plugin; Character codes; Ufuncs
    ...
    _80Bit, _96Bit, _128Bit, _256Bit, _ArrayLikeBool_co, _ArrayLikeComplex_co,
    _ArrayLikeDT64_co, _ArrayLikeFloat_co, _ArrayLikeInt, _ArrayLikeInt_co,
...
from typing import (NoReturn, SupportsComplex, SupportsFloat, SupportsIndex,
                    SupportsInt, TypeAlias, final, type_check_only)
...
from numpy import (char, core, ctypeslib, dtypes, exceptions, f2py, fft, lib,
                   linalg, ma, polynomial, random, rec, strings, testing,
                   typing, version)
...
from typing_extensions import (CapsuleType, Generic, LiteralString, Never,
                               Protocol, Self, TypeVar, Unpack, deprecated,
                               overload)
