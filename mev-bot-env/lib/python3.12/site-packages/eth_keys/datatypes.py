...
from eth_keys.validation import (validate_compressed_public_key_bytes,
...
from eth_utils import (ValidationError, big_endian_to_int, encode_hex,
                       int_to_big_endian, is_bytes, is_string, keccak,
...
class LazyBackend:
    def __init__(
        ...
        from eth_keys.backends.base import BaseECCBackend  # noqa: F811
