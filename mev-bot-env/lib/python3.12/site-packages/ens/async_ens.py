...
from typing import (TYPE_CHECKING, Any, Coroutine, Optional, Sequence, Tuple,
                    Union, cast)

from ens import abis
from ens.base_ens import BaseENS
from ens.constants import (EMPTY_ADDR_HEX, ENS_EXTENDED_RESOLVER_INTERFACE_ID,
                           ENS_MAINNET_ADDR,
                           ENS_MULTICHAIN_ADDRESS_INTERFACE_ID,
                           ENS_TEXT_INTERFACE_ID, REVERSE_REGISTRAR_DOMAIN)
from ens.exceptions import (AddressMismatch, ENSValueError, ResolverNotFound,
                            UnauthorizedError, UnownedName,
                            UnsupportedFunction)
from ens.utils import (address_in, address_to_reverse_domain, default,
                       ens_encode_name, init_async_web3, is_empty_name,
                       is_none_or_zero_address, label_to_hash,
                       normal_name_to_hash, normalize_name, raw_name_to_hash)
from eth_typing import Address, ChecksumAddress, HexAddress, HexStr
from eth_utils import (is_address, is_binary_address, is_checksum_address,
                       to_checksum_address)
from eth_utils.toolz import merge
from hexbytes import HexBytes

if TYPE_CHECKING:
    from web3.contract.async_contract import (AsyncContract,  # noqa: F401
                                              AsyncContractFunction)
    from web3.main import AsyncWeb3  # noqa: F401
    from web3.middleware.base import Middleware  # noqa: F401
    from web3.providers import AsyncBaseProvider, BaseProvider  # noqa: F401
