...
from typing import (TYPE_CHECKING, Any, Collection, Optional, Sequence, Tuple,
                    Type, Union, cast)

from ens.exceptions import ENSTypeError, ENSValueError
from eth_typing import Address, ChecksumAddress, HexAddress, HexStr
from eth_utils import (is_same_address, remove_0x_prefix, to_bytes,
                       to_normalized_address)
from hexbytes import HexBytes

from .constants import (ACCEPTABLE_STALE_HOURS, AUCTION_START_GAS_CONSTANT,
                        AUCTION_START_GAS_MARGINAL, EMPTY_ADDR_HEX,
                        EMPTY_SHA3_BYTES, REVERSE_REGISTRAR_DOMAIN)
from .exceptions import ENSValidationError, InvalidName
...
if TYPE_CHECKING:
    ...
    from web3.middleware.base import Middleware
...
def normalize_name(name: str) -> str:
    ...
    from ._normalization import normalize_name_ensip15
