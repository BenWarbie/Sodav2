...
from random import getrandbits, randint, randrange, shuffle

pyodide = bool(platform.machine() == 'wasm32')
is_pypy = bool(platform.python_implementation() == 'PyPy')


from bitarray import (__version__, _bitarray_reconstructor,
                      _set_default_endian, _sysinfo, bitarray, bits2bytes,
                      decodetree, frozenbitarray, get_default_endian)
